...
Check the [releases](https://github.com/droboports/screen/releases) page. If there are no releases available, then you have to compile.
...
```
git clone https://github.com/droboports/screen.git
cd screen
./build.sh
```
